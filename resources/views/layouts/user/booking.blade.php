...
<body>
    ...
    <script>
        var bookingEvents = @json($bookings);
    </script>


    <script>
        var getDetailsUrl = "{{ route('get-transportation-details', ['id' => ':id']) }}";
    </script>

    <script>
        var addBooking = "{{ route('user.add.booking') }}";
    </script>

    <script>
        var getTransportationClientURL = "{{ route('get.transportation.details.for.client') }}";
    </script>
