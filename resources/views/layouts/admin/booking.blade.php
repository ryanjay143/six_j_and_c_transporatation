...
<head>
    ...
    <title>{{ __('Booking Calendar') }}</title>
    ...
    <body class="sb-nav-fixed">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav ">
                            ...
                            <a class="nav-link active" href="{{ route('booking.calendar') }}">
        ...
        <script>
            var getAssignedCompaniesURL = "{{ route('getAssignedCompanies') }}";
        </script>

        <script>
            var getAssignedTruckURL = "{{ route('getAssignedTruck') }}";
        </script>

        <script>
            var getAssignedTruck = "{{ route('getAssignedTruckURL') }}";
        </script>

        <script>
            var getAssignedDriverURL = "{{ route('getAssignedDriver') }}";
        </script>

        <script>
            var getAssignedDriverForClientURL = "{{ route('getAssignedDriverForClient') }}";
        </script>

        <script>
            var getAssignedHelperURL = "{{ route('getAssignedHelper') }}";
        </script>

        <script>
            var getBookingsClientURL = "{{ route('get.bookings.client') }}";
        </script>

        <script>
            var getCalendarUpdateURL = "{{ route('calendar.update', '') }}";
        </script>

        <script>
            var getDriverCountURL = "{{ url('api/driver-assignment-counts') }}";
        </script>
        
        <script>
            var bookingForClientURL = "{{ route('admin.booking.for.client') }}";
        </script>

        <script>
            var bookingFromClient = "{{ route('admin.booking.from.client') }}";
        </script>

        <script>
            var checkFullyBookedURL = "{{ route('admin.check-fully-booked') }}";
        </script>

        <script>
            var gettodaysBookingdate = "{{ route('admin.todaysBooking.date') }}";
        </script>
