    ...
    <body class="sb-nav-fixed">
      ...
      <script>
        ...
        <script>
            ...
            let damageDeductionAmount = @json($damageAmount ?? 0);
        </script>

        <script>
            $(document).ready(function () {
                $('#cashAdvance_{{ $employee->id }}').DataTable();
            });
        </script>
        <script>
            $(document).ready(function () {
                $('#damage_{{ $employee->id }}').DataTable();
            });

            $(document).ready(function () {
                $('#payroll_{{ $employee->id }}').DataTable();
            });
        </script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                var secondModalButtons = document.querySelectorAll("[id^='secondModalButton']");

                secondModalButtons.forEach(function (button) {
        ...
        <script>
            function showModal(damageId) {
                var modal = new bootstrap.Modal(document.getElementById('modal5' + damageId));
                modal.show();
            }
        </script>
        ...
        <script>
            document.getElementById('savePayrollButton').addEventListener('click', function() {
                // Change the values of the date fields to "16 and 30"
                document.querySelector('input[name="start_date"]').value = '{{ date('Y-m-16') }}';
