...
<head>
    ...
    <title>{{ __('View Payroll Details') }}</title>
    ...
    <body class="sb-nav-fixed">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav ">
                            ...
                            <!-- <a class="nav-link active" href="{{ route('payroll.info') }}">
                            ...
                            <a class="nav-link collapsed active" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts1" aria-expanded="false" aria-controls="collapseLayouts1">
        ...
        <script>
            ...
            dateFilterForm.addEventListener('submit', function (e) {
                ...
                const fromDate = new Date(document.querySelector('#dateFilterForm input[name="from"]').value);
                const toDate = new Date(document.querySelector('#dateFilterForm input[name="to"]').value);
