                                                                ...
                                                                <tfoot class="table-hover">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        if ($cashAdvanceHelper && $cashAdvanceHelper->pay_seq > 0) {
                                                                            $cashAdvanceAmount = $cashAdvanceHelper->amount / $cashAdvanceHelper->pay_seq;
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        if ($damagesHelper && $damagesHelper->damage_sequence > 0) {
                                                                            $damageAmount =$damagesHelper->deduction / $damagesHelper->damage_sequence;
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                                ...
                                                                                <input type="text" hidden="" id="employeeId" name="employee_id" value="{{ $employee->id }}">
                                                                                ...
                                                                                @php
                                                                                    ...
                                                                                    if ($cashAdvanceHelper) {
                                                                                        if ($cashAdvanceHelper->pay_seq > 0) {
                                                                                            $cashAdvanceAmount = $cashAdvanceHelper->amount / $cashAdvanceHelper->pay_seq;
                                                                                            $roundedCashAdvanceAmount = round($cashAdvanceAmount); // Round off the cash advance amount
                                                                                        }

                                                                                        $cashBalance = $cashAdvanceHelper->amount - $roundedCashAdvanceAmount;
                                                                                    }
                                                                                @endphp

                                                                                <input type="text" hidden="" name="caId" value="{{ isset($cashAdvanceHelper) ? $cashAdvanceHelper->id : '' }}">
                                                                                ...
                                                                                @php
                                                                                    ...
                                                                                    if ($damagesHelper && $damagesHelper->damage_sequence > 0) {
                                                                                        $damageAmount = $damagesHelper->deduction / $damagesHelper->damage_sequence;
                                                                                        $balanceDeduction = $damagesHelper->deduction - $damageAmount;
                                                                                        $roundedDamageAmount = round($damageAmount); // Round off the damage amount
                                                                                    }
                                                                                @endphp
                                                                                ...
                                                                                @if ($roundedTotalDeduction > 0)
                                                                                    <input value="{{ $roundedTotalDeduction }}" id="totalDeduction" hidden="" name="totalDeduction" type="text" 
                                                                                ...
                                                                                @foreach ($helper as $h)
                                                                                        ...
                                                                                        <input type="text" hidden=""  name="transpo_id[]" value="{{ $h->id }}">
                                                                                ...
                                                                                @endforeach
                                                                                <button type="button" class="btn btn-primary btn-sm w-100" id="savePayrollButton" disabled>
